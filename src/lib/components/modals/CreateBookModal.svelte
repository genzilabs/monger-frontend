...
<BottomSheet {open} onClose={handleClose} title="Create New Book">
	<div class="space-y-4">
		<div>
			<label for="book-name" class="block text-sm font-medium text-secondary mb-1.5">
				Book Name
			</label>
			<input
				id="book-name"
		...
		<div>
			<label for="book-description" class="block text-sm font-medium text-secondary mb-1.5">
	...
	<div class="flex gap-3 mt-6">
		...
		<Button variant="primary" fullWidth loading={isCreating} onclick={handleSubmit}>Create Book</Button>
	</div>
</BottomSheet>
