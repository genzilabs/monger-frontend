...
<div class="animate-fade-in space-y-5">
	...
	{:else if booksStore.activeBook}
		...
		<div class="grid grid-cols-4 gap-3">
			...
			<QuickActionButton label="Pocket" onclick={() => (showCreatePocketModal = true)}>
				{#snippet icon()}
					<svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
		...
		<div class="grid grid-cols-2 gap-4">
			<StatCard title="Spending">
				...
				<div class="flex items-center justify-center py-2 relative">
					<svg class="rotate-[-90deg]" height="80" viewBox="0 0 80 80" width="80">
						<circle cx="40" cy="40" fill="none" r="32" stroke="var(--color-border)" stroke-width="8"></circle>
						<circle cx="40" cy="40" fill="none" r="32" stroke="var(--color-primary)" stroke-dasharray="140 200" stroke-linecap="round" stroke-width="8"></circle>
					</svg>
					<div class="absolute inset-0 flex items-center justify-center flex-col">
						<span class="text-[10px] text-muted">Total</span>
						<span class="text-sm font-bold text-foreground">{booksStore.pockets.length}</span>
					</div>
				</div>
			</StatCard>
				...
				<div class="space-y-3">
					<div>
						<div class="flex justify-between text-xs mb-1">
							<span class="text-foreground font-medium">Pockets</span>
					...
					<div>
						<div class="flex justify-between text-xs mb-1">
							<span class="text-foreground font-medium">Health</span>
		...
		<div class="space-y-3">
			<div class="flex justify-between items-center">
				<h3 class="text-sm font-semibold text-foreground">Your Pockets</h3>
			...
			<div class="flex overflow-x-auto gap-4 pb-2 no-scrollbar -mx-6 px-6">
				{#if booksStore.pockets.length === 0}
					...
					>
						...
						<span class="text-xs text-muted">Add Pocket</span>
					</button>
				{:else}
	...
	{:else if booksStore.books.length > 0}
		<div class="text-center py-10">
			...
			<h2 class="text-lg font-semibold text-foreground mb-2">Select a Book</h2>
			<p class="text-secondary">Tap on the book selector above to choose a book.</p>
		</div>
	{:else}
		<div class="text-center py-10">
			<div class="w-16 h-16 mx-auto mb-4 bg-primary/10 rounded-full flex items-center justify-center">
			...
			<h2 class="text-lg font-semibold text-foreground mb-2">Start Your Financial Journey</h2>
			<p class="text-secondary">Tap the book selector to create your first book.</p>
		</div>
	{/if}
</div>
